...
namespace addons\ResourcesCenter\merchant\controllers;

use Yii;
use common\helpers\ArrayHelper;
use common\interfaces\AddonsSetting;
use addons\ResourcesCenter\common\models\SettingForm;

/**
 * 参数设置
 *
 * Class SettingController
 * @package addons\ResourcesCenter\merchant\controllers
 */
