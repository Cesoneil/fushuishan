...
class m210820_141319_addon_register_form_merchant_config extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%addon_register_form_merchant_config}}', [
            ...
            'header_img' => "text NOT NULL COMMENT '头部图片'",//可以一张或者多张
...
//           'default_agreement'=> "tinyint(1) unsigned NULL DEFAULT '1' COMMENT '头部动态[0:不使用；1:使用]'",
            'agreement' => "text NULL  COMMENT '商家协议内容'",//如果为空使用默认协议
            'footer_img' => "text NULL  COMMENT '尾部图片'",//可以0张或者多张
        ...
        /* 索引设置 */
        $this->createIndex('merchant_id','{{%addon_register_form_merchant_config}}','merchant_id',0);
